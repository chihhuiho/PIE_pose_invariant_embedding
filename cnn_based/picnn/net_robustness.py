...
from util_robustness import mvcnn_VGG_avg, load_data, mvDataset, compute_acc
...
parser.add_argument('--alpha', action='store', default=0.1, type=float, help='alpha (default: 1.0)')
parser.add_argument('--beta', action='store', default=0.1, type=float, help='beta (default: 1.0)')
...
def main():
    ...
    ch = logging.FileHandler('log_robustness/logfile_'+arg.net+'_'+arg.dataset + '_' + str(arg.alpha)+ '_'+ str(arg.beta)+ '_' + str(arg.trial)  + '.log')
