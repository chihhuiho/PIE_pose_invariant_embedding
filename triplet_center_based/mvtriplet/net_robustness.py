...
from util_robustness import VGG_avg_mvtc, compute_acc, mvDataset, load_data
...
def main():
    ...
    ch = logging.FileHandler('log_robustness/logfile_'+arg.net+'_'+arg.dataset + '_' + str(arg.margin) + '_' + str(arg.trial)  + '.log')
    ...
    if arg.net == 'VGG_avg':
        model = VGG_avg_mvtc(input_view, output_class)
